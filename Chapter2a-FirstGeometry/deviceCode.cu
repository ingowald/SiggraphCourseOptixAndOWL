...
#if 1
 // this is a camera that looks at a unit box, from the top left
 // front, assuming a 4:3 (ie 1600x1200) aspect ratio (generated by
 // dumping these values from an interactive viewer)
  vec3f rayOrigin = vec3f(-0.96,1.28,2.4);
  vec3f rayDirection
    = vec3f(-0.566416,-0.96115,-0.915804)
    + u * vec3f(1.60817,-0,0.643267)
    + v * vec3f(0.190304,1.03478,-0.475761);
#else
  // this is a hand-crafted camera that looks at a unit box from the
  // front, assuming a 1:1 aspect ratio.
